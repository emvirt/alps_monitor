 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: chip_wdt.h 575 2011-09-29 14:01:06Z ertl-tohta $
 */
 ...
 *  タイマ割込みハンドラ登録のための定数
 */
#define INHNO_TIMER_PRC1     (0x00010000 | DIC_IRQNO_WDT) /* 割込みハンドラ番号 */
#define INHNO_TIMER_PRC2     (0x00020000 | DIC_IRQNO_WDT) /* 割込みハンドラ番号 */
#define INHNO_TIMER_PRC3     (0x00030000 | DIC_IRQNO_WDT) /* 割込みハンドラ番号 */
#define INHNO_TIMER_PRC4     (0x00040000 | DIC_IRQNO_WDT) /* 割込みハンドラ番号 */

#define INTNO_TIMER_PRC1     (0x00010000 | DIC_IRQNO_WDT) /* 割込み番号 */
#define INTNO_TIMER_PRC2     (0x00020000 | DIC_IRQNO_WDT) /* 割込み番号 */
#define INTNO_TIMER_PRC3     (0x00030000 | DIC_IRQNO_WDT) /* 割込み番号 */
#define INTNO_TIMER_PRC4     (0x00040000 | DIC_IRQNO_WDT) /* 割込み番号 */
