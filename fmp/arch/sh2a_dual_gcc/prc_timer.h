 ...
 */
										/* 割込みハンドラ番号 */
#define INHNO_TIMER     (CMI0_VECTOR | (TOPPERS_SYSTIM_PRCID << 16))
#define INTNO_TIMER     INHNO_TIMER   	/* 割込み番号 */
...
{
	return(sil_reh_mem((void*)CMCNT_0));
}
...
{
	return((sil_reh_mem((void*)CMCSR_0) & CMCSR_CMF) == CMCSR_CMF);
}
