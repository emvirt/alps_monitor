 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: target_config.h 580 2010-04-27 08:23:38Z ertl-honda $
 */
 ...
 * (モデル上の)割り要求禁止フラグの解除
 *
 * 指定された，割込み番号の割込み要求禁止フラグのクリアをして，割込みを
...
x_enable_int(INTNO intno)
{
	...
	at91skyeye_enable_int(INTNO_BITPAT(INTNO_MASK(intno)));
	p_tpcb->idf &= ~INTNO_BITPAT(INTNO_MASK(intno));
	return(true);
}
 ...
 */
#define TO_NATIVE_ID(spnid)		(spnid + 20)
