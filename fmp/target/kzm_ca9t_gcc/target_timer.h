 ...
 *  チップ依存モジュール（MPCORE用）
 */
#include "arm_gcc/mpcore/chip_wdt.h"
...
#define INHNO_TIMER     DIC_IRQNO_TM_SP804_0  /* 割込みハンドラ番号 */
#define INTNO_TIMER     DIC_IRQNO_TM_SP804_0  /* 割込み番号 */
...
#define TO_NSEC(clock)		 (((SYSUTM) clock) * 1000000U / TIMER_CLOCK)
...
{
  return(TO_CLOCK(TIC_NUME, TIC_DENO) - sil_rew_mem((void *)(TIMER_BASE_REG + TIMER_SP804_1VALUE)));
}
