 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: mp.h 444 2009-10-16 06:45:49Z ertl-honda $
 */
 ...
 *  タスクロックの解放とディスパッチ
 */
extern void release_tsk_lock_and_dispatch(PCB *p_pcb, bool_t dspreq);
...
/*
 *  2個のタスクロックの解放とディスパッチ（タスクコンテキスト）
 */
extern void release_dual_tsk_lock_and_dispatch(PCB *p_srcpcb,  PCB *p_dstpcb,
											   bool_t dspreq);
 ...
 * オブジェクトロックの解放とディスパッチ
 */ 
extern void release_obj_lock_and_dispatch(LOCK *p_objlock, bool_t dspreq);
