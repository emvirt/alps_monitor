 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: sh_scif.c 558 2010-04-02 15:00:35Z ertl-honda $
 */
...
typedef struct sio_port_initialization_block {
	void  *scsmr_h;   /* シリアルモードレジスタ */
	void  *scbrr_b;   /* ビットレートレジスタ */
	void  *scscr_h;   /* シリアルコントロールレジスタ */
	void  *scftdr_b;  /* トランスミットFIFOデータレジスタ */
	void  *scfsr_h;   /* シリアルステータスレジスタ */
	void  *scfrdr_b;  /* レシーブFIFOデータレジスタ */
	void  *scfcr_h;   /* FIFOコントロールレジスタ */
	void  *scfdr_h;   /* レシーブFIFOデータ数レジスタ */
	void  *scsptr_h;  /* シリアルポートレジスタ */
...
static const SIOPINIB siopinib_table[TNUM_SIOP] = {
	{
		(void *)(SH_SCIF0_BASE + SCIF_SCSMR),
		(void *)(SH_SCIF0_BASE + SCIF_SCBRR),
		(void *)(SH_SCIF0_BASE + SCIF_SCSCR),
		(void *)(SH_SCIF0_BASE + SCIF_SCFTDR),
		(void *)(SH_SCIF0_BASE + SCIF_SCFSR),
		(void *)(SH_SCIF0_BASE + SCIF_SCFRDR),
		(void *)(SH_SCIF0_BASE + SCIF_SCFCR),
		(void *)(SH_SCIF0_BASE + SCIF_SCFDR),
		(void *)(SH_SCIF0_BASE + SCIF_SCSPTR),
		SCIF0_BPS_SETTING,
		SCIF0_CKE_SETTING
	},
#if TNUM_SIOP >= 2
	{        
		(void *)(SH_SCIF1_BASE + SCIF_SCSMR),
		(void *)(SH_SCIF1_BASE + SCIF_SCBRR),
		(void *)(SH_SCIF1_BASE + SCIF_SCSCR),
		(void *)(SH_SCIF1_BASE + SCIF_SCFTDR),
		(void *)(SH_SCIF1_BASE + SCIF_SCFSR),
		(void *)(SH_SCIF1_BASE + SCIF_SCFRDR),
		(void *)(SH_SCIF1_BASE + SCIF_SCFCR),
		(void *)(SH_SCIF1_BASE + SCIF_SCFDR),
		(void *)(SH_SCIF1_BASE + SCIF_SCSPTR),
		SCIF1_BPS_SETTING,
		SCIF1_CKE_SETTING
	},
#endif /* TNUM_SIOP >= 2 */
#if TNUM_SIOP >= 3
	{
		(void *)(SH_SCIF2_BASE + SCIF_SCSMR),
		(void *)(SH_SCIF2_BASE + SCIF_SCBRR),
		(void *)(SH_SCIF2_BASE + SCIF_SCSCR),
		(void *)(SH_SCIF2_BASE + SCIF_SCFTDR),
		(void *)(SH_SCIF2_BASE + SCIF_SCFSR),
		(void *)(SH_SCIF2_BASE + SCIF_SCFRDR),
		(void *)(SH_SCIF2_BASE + SCIF_SCFCR),
		(void *)(SH_SCIF2_BASE + SCIF_SCFDR),
		(void *)(SH_SCIF2_BASE + SCIF_SCSPTR),
		SCIF2_BPS_SETTING,
		SCIF2_CKE_SETTING
	},
#endif /* TNUM_SIOP >= 3 */
#if TNUM_SIOP >= 4
	{
		(void *)(SH_SCIF3_BASE + SCIF_SCSMR),
		(void *)(SH_SCIF3_BASE + SCIF_SCBRR),
		(void *)(SH_SCIF3_BASE + SCIF_SCSCR),
		(void *)(SH_SCIF3_BASE + SCIF_SCFTDR),
		(void *)(SH_SCIF3_BASE + SCIF_SCFSR),
		(void *)(SH_SCIF3_BASE + SCIF_SCFRDR),
		(void *)(SH_SCIF3_BASE + SCIF_SCFCR),
		(void *)(SH_SCIF3_BASE + SCIF_SCFDR),
		(void *)(SH_SCIF3_BASE + SCIF_SCSPTR),
		SCIF3_BPS_SETTING,
		SCIF3_CKE_SETTING
	}
#endif /* TNUM_SIOP >= 4 */
...
sh_scif_init_siopinib(const SIOPINIB *p_siopinib)
{
	...
	sil_wrh_mem(p_siopinib->scfsr_h,
                sil_rew_mem(p_siopinib->scfsr_h) & ~(SCFSR_TEND|SCFSR_TDFE));
...
sh_scif_pol_putc(char_t c, ID siopid)
{
	...
	while((sil_reh_mem(p_siopinib->scfsr_h) & SCFSR_TDFE) == 0);
    
	sil_wrb_mem(p_siopinib->scftdr_b, c);
	sil_wrh_mem(p_siopinib->scfsr_h,
                (sil_reh_mem(p_siopinib->scfsr_h) & ~(SCFSR_TDFE)));
