 ...
 *  primsgq.c
 */
#undef initialize_primsgq
#undef enqueue_primsg
#undef dequeue_primsg
#undef send_primsg
#undef receive_primsg

/*
 *  shmem.c
 */
#undef initialize_shmem
 ...
 *  primsgq.c
 */
#undef _initialize_primsgq
#undef _enqueue_primsg
#undef _dequeue_primsg
#undef _send_primsg
#undef _receive_primsg

/*
 *  shmem.c
 */
#undef _initialize_shmem
...
#undef _tmax_pmqid
#undef _pmqcb_table
#undef _pmqinib_table
#undef _tmax_shmid
#undef _shmcb_table
#undef _shminib_table
#undef _tmax_mbxid
#undef _mbxcb_table
