 ...
 *  primsgq.c
 */
#define initialize_primsgq			_kernel_initialize_primsgq
#define enqueue_primsg				_kernel_enqueue_primsg
#define dequeue_primsg				_kernel_dequeue_primsg
#define send_primsg					_kernel_send_primsg
#define receive_primsg				_kernel_receive_primsg

/*
*  shmem.c
*/
#define initialize_shmem			_kernel_initialize_shmem
...
#define tmax_pmqid					_kernel_tmax_pmqid
#define pmqcb_table					_kernel_pmqcb_table
#define pmqinib_table				_kernel_pmqinib_table
#define tmax_shmid					_kernel_tmax_shmid
#define shmcb_table					_kernel_shmcb_table
#define shminib_table				_kernel_shminib_table
 ...
 *  primsgq.c
 */
#define _initialize_primsgq			__kernel_initialize_primsgq
#define _enqueue_primsg				__kernel_enqueue_primsg
#define _dequeue_primsg				__kernel_dequeue_primsg
#define _send_primsg				__kernel_send_primsg
#define _receive_primsg				__kernel_receive_primsg

/*
*  shmem.c
*/
#define _initialize_shmem			__kernel_initialize_shmem
...
#define _tmax_pmqid					__kernel_tmax_pmqid
#define _pmqcb_table				__kernel_pmqcb_table
#define _pmqinib_table				__kernel_pmqinib_table
#define _tmax_shmid					__kernel_tmax_shmid
#define _shmcb_table				__kernel_shmcb_table
#define _shminib_table				__kernel_shminib_table
