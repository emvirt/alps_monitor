...
/* primsgq.c */
#define TOPPERS_pmqini
#define TOPPERS_pmqenq
#define TOPPERS_pmqdeq
#define TOPPERS_pmqsnd
#define TOPPERS_pmqrcv
#define TOPPERS_snd_pmq
#define TOPPERS_psnd_pmq
#define TOPPERS_ipsnd_pmq
#define TOPPERS_tsnd_pmq
#define TOPPERS_rcv_pmq
#define TOPPERS_prcv_pmq
#define TOPPERS_trcv_pmq
#define TOPPERS_ini_pmq
#define TOPPERS_ref_pmq

/* shmem.c */
#define TOPPERS_shmini
#define TOPPERS_get_shm
