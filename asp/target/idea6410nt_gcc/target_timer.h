 ...
 *  の責任を負わない．
 *
 *  @(#) $Id: target_timer.h 264 2007-07-12 08:23:10Z hiro $
 */
 ...
 *  タイマ割込みハンドラ登録のための定数
 */
#define INHNO_TIMER     IRQNO_TIMER  /* 割込みハンドラ番号 */
#define INTNO_TIMER     IRQNO_TIMER  /* 割込み番号 */
#define INTPRI_TIMER    -5           /* 割込み優先度 */
#define INTATR_TIMER    0            /* 割込み属性 */
 ...
 *  
 *  We use maximum resolution (div=1/1 prescaler=1 -> 66MHz)
 */
...
{
	return TO_CLOCK(TIC_NUME, TIC_DENO) - sil_rew_mem((void *)(TARGET_TIMER_TCNTO));
}
