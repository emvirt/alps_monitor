...
$  割込みマスクテーブル
$ 
const uint64_t _kernel_ipm_mask_tbl[(TMAX_INTPRI - TMIN_INTPRI + 1)]={$NL$
$FOREACH intpri {0,-1,...,-31}$
 $intmask = 0$
 $FOREACH intno (INT.ID_LIST)$
  ...
  $END$
 $END$
 $TAB$UINT64_C($FORMAT("0x%016x", intmask)$),/* Priority $+intpri$ */$NL$
$END$
$NL$
};$NL$
